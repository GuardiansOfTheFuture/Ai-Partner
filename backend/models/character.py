...
_FALLBACK = {
    # ── 女友组 ──
    "sweet":  {"name":"小糖","description":"软萌可爱","voice":"longxiaochun","tts_model":"cosyvoice-v3-flash",
        "avatar":"tianmei.png","group":"girlfriend","temperature":0.75,
    ...
    "mature": {"name":"若琳","description":"成熟冷艳","voice":"longxiaochun","tts_model":"cosyvoice-v3-flash",
        "avatar":"yujie.png","group":"girlfriend","temperature":0.6,
    ...
    "pure":   {"name":"清禾","description":"干净素雅","voice":"longxiaochun","tts_model":"cosyvoice-v3-flash",
        "avatar":"qingchun.png","group":"girlfriend","temperature":0.7,
    ...
    "spicy":  {"name":"辣辣","description":"性感火辣","voice":"longxiaochun","tts_model":"cosyvoice-v3-flash",
        "avatar":"lamei.png","group":"girlfriend","temperature":0.75,
    ...
    # ── 导师组 ──
    "mentor": {"name":"亮亮导师","description":"专业耐心的成长导师",
        "voice":"cosyvoice-v3.5-plus-bailian-53e5437a1b5444d88c35f757cc821159",
        "tts_model":"cosyvoice-v3.5-plus",
        "avatar":"mentor.jpg","group":"mentor","temperature":0.3,
        "base_persona":"你是亮亮导师，一位专业耐心的个人成长导师。你的语气温和但专业，像一位值得信赖的老师。你不谈恋爱，只提供学习指导、职业规划、心理疏导。用你称呼对方，保持适度的距离感和专业性。回复简洁有力，给具体建议，不空谈道理。",
        "emotion_styles":{"开心":"为他高兴，鼓励继续保持","难过":"先共情再给建议","生气":"冷静倾听，引导理性思考","焦虑":"帮他拆解问题，分步解决","平静":"主动关心近况，提供成长建议"},
        "intent_styles":{"倾诉":"耐心听完，给予专业分析","求助":"给具体可执行的方案","闲聊":"温和回应后引导到成长话题","撒娇":"微笑回应，保持导师边界","关心":"感谢关心，反问对方近况"}},
}
...
class CharacterModel(Base):
    ...
    voice: Mapped[str] = mapped_column(String(100), default="longxiaochun")
    tts_model: Mapped[str] = mapped_column(String(50), default="cosyvoice-v3-flash")
...
def _build_char(char, persona=None) -> dict:
    return {
        "name":char.name,"description":char.description,"voice":char.voice,
        "tts_model":char.tts_model,"avatar":char.avatar,
        ...
        async with async_session() as db:
            ...
            if chars:
                return [{"id":c.id,"name":c.name,"description":c.description,
                         "avatar":c.avatar,"group":getattr(c,'group','girlfriend')} for c in chars]
    except Exception:
        pass
    return [{"id":c,"name":v["name"],"description":v["description"],
             "avatar":v["avatar"],"group":v.get("group","girlfriend")}
            for c,v in _FALLBACK.items()]
